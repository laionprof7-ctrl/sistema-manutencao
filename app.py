...
from config import (
    ARQUIVO_LOGO, NIVEIS, PRIORIDADES, VEICULOS,
)
...
SESSION_POLICY_VERSION = "prod-1h-20260911-v1"
...
# Ao mudar a política de sessão, aplica a nova duração uma única vez.
...
if not st.session_state.logged_in:
    ...
    with col:
        ...
        st.caption("Sistema interno de gestão operacional")
